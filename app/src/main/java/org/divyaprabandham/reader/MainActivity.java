...
public final class MainActivity extends Activity {
    ...
    private void showHome(){page="Home";start("Divya Prabandham","Offline · 25 prabandhams","Home");
        ...
        add(icons,text("Choose the full rounded painting or the transparent Ramanujar-and-deity cutout. Some launchers take a moment to update.",12,muted(),false));
        ...
        add(icons,button(cutoutIcon?"Cutout selected":"Use figure cutout",()->setLauncherIcon(true),cutoutIcon));
